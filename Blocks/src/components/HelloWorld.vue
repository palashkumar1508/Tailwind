...
<template >
  ...
  <div :class="{bcDark:darkM}" class="max-w-full max-h-full">
...
<style scoped>
  ...
  .inside{
    @apply rounded-r-full w-20 h-9 bg-gray-400 p-9 mx-auto my-auto text-center text-white
  }
